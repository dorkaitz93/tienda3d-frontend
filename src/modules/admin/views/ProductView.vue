    ...
    <form class="grid grid-cols-1 sm:grid-cols-2 bg-white px-5 gap-5">
      <div class="first-col">
        ...
        <div class="mb-4">
          ...
          <textarea
            id="description"
            class="shadow h-32 appearance-none border rounded w-full py-2 px-3 text-gray-500 leading-tight focus:outline-none focus:shadow-outline"
          ></textarea>
        </div>
        ...
        <div class="mb-4">
          <label for="sizes" class="form-label">Tallas</label>
            <div class ="flex">
                ...
                type="button" class="bg-blue-100 p-2 rounded w-14 mr-2 flex-1">{{ size }}</button>
            </div>      
        </div>
      </div>
